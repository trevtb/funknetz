...
public class Jammer {
	...
	**/
	public void draw() {
		...
		ImageIcon frameIcon_ref = new ImageIcon(ClassLoader.getSystemResource("de/funknetz/client/resource/jammer_s.gif"));
		...
		ImageIcon zurueckButIcon_ref = new ImageIcon(ClassLoader.getSystemResource("de/funknetz/client/resource/zurueck.gif"));
		JButton zurueckButton_ref = new JButton("Zurueck", zurueckButIcon_ref);
		zurueckButton_ref.setActionCommand("Zurueck");
		zurueckButton_ref.addActionListener(new ButtonListener());
		ImageIcon startButIcon_ref = new ImageIcon(ClassLoader.getSystemResource("de/funknetz/client/resource/ok.gif"));
		JButton startButton_ref = new JButton("Start", startButIcon_ref);
		startButton_ref.setActionCommand("Start");
		...
		JButton abbrButton_ref = new JButton("Stopp", abbrButIcon_ref);
		abbrButton_ref.setActionCommand("Stopp");
	...
	class JamRun implements Runnable {
		public void run() {
			...
			try {
				...
				s_ref.bind(null);
				s_ref.connect(new InetSocketAddress(MainGui.getIP(), MainGui.getPort()), 2000);
