...
public class FunknetzClient {
	...
	private static String[][] schalterNamen_class;
	...
	**/
	 ...
	 */
	public static String[][] getSNamen() {
		return schalterNamen_class;
	} //endmethod getSNamen
	 ...
	 */
	public static void setSNamen(String[][] sNamen_ref) {
		schalterNamen_class = sNamen_ref;
	} //endmethod setSNamen
	...
	private void updateIni() {
		...
		schalterNamen_class = (String[][]) iniArrayList_ref.get(1);
		selectedChan = ((Integer) iniArrayList_ref.get(4)).intValue();
		ip_class = (String) iniArrayList_ref.get(2);
		port = (Integer) iniArrayList_ref.get(3);
	} //endmethod updateIni
	...
	**/
	public static void setIni () {
		...
		helfer_class.writeIni(kanalNamen_class, schalterNamen_class, ip_class, port, sel_ref);
	} //endmethod setIni
